...
#define  ADC_AV 1
    #define ADC_ANT_AV 1
      #if not defined( PWM_AV)
        #define ADC_ANT_ISR_AV 1
      #endif

    #define xADC_ANT_HX_SHOW_AV 1
...
//
// @see  WOT: main.h -> API_install
//



// #STD
   //#define API0_STD0_AV    1
   //#define API1_STD0_AV  1
   //#define API2_STD0_AV  1
   //#define API3_STD0_AV  1
      //
      //#include <api0_STD0.h>


// #MSX0
   //#define API0_MSX0_AV  1
   #define API1_MSX0_AV    1
   //#define API2_MSX0_AV  1
   //#define API3_MSX0_AV  1
      //
      #include <api1_MSX0.h>
