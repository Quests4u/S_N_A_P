...
bool COM_exec(){
...
#ifdef COM_EP_LEN_AV
  case COMI_EP_LEN:
          _len=sizeof( EP_prem_t)+sizeof( EP_bulk);
...
#endif
        // on auto: show->T 
#ifdef VIS_COM_AV//&VIS_AV
  case COMI_A_LCD:
          _vis_ms_setup=VSI_MS_AUTO;
          //
          //_.add=true;
          //_.vis=true;
          //_.SO=true;
  ...
  case COMI_EP_2_PWM:
          ...
          case COMI_EP_2_PWM:
            ...
            com_para_put.concat( _PWM_DAC_null);
          }
          */
              }
        #endif
...
#ifdef SIO_COM_SESTU_AV//&SIO_SESTU_AV
  case COMI_SESTU_PARA:
          if (com_f0Has){
            //
            //SO_sestu=com_f0;
