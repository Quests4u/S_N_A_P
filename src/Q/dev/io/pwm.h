...
#define  PWM_PIN_DAC_H           9              // D9(o)    = PB1/PCM(H)
...
#define  PWM_H0_0             0.0       //  -> 0%     = 0%    (0)
#define  PWM_H0_M             100.0     //  -> 100%   = 100%  (255)
...
extern int16_t           _PwmValue;//

#ifdef PWM_AD_AV

extern int               pwm_t_value;//     = -1;
extern int               pwm_p_value;//     = -1;
extern int               pwm_h_value;//     = -1;
...
//
extern double            pwm_h_0;//         = PWM_F0_0;
extern double            pwm_h_M;//         = PWM_F0_M;
 ...
 * @return _pwm
 */
extern int16_t _PWM_setTestDAC( 
            double _v
          );
