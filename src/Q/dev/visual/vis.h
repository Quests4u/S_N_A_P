...
#define  VSI_MS_AUTO          0x00
  #define  VSI_MS_SN            0x0F
#define  VSI_MS_ROTATE        0x10


#define  VSI_MS_T             0x01
#define  VSI_MS_P             0x02
#define  VSI_MS_F             0x03
...
//extern const char*         _tx_vis_off;//   = TX_VIS_OFF;
//extern const char*         _tx_vis_on;//    = TX_VIS_ON;
